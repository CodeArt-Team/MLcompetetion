...
class LibraryInstall():
    def install():
        ...
        try:import rdkit        
            ...
            print(yellow("👻👻👻👻 -- Install : rdkit",True))
            subprocess.call([sys.executable, "-m", "pip", "install", 'rdkit'])
        finally:import rdkit 
        
        ## sklearn check
        try:import sklearn        
        except ModuleNotFoundError:
            print(yellow("👻👻👻👻 -- Install : scikit learn",True))
            subprocess.call([sys.executable, "-m", "pip", "install", 'scikit-learn'])
        finally:import sklearn 
